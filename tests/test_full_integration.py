...
class TestMCPServerIntegration:
    ...
    def test_mcp_server_complete_integration(self):
        ...
        # Mock the environment variables for MCP server creation if not present
        with patch.dict(
            os.environ,
            {
                "JUSTIFI_CLIENT_ID": os.getenv("JUSTIFI_CLIENT_ID", "test_client_id"),
                "JUSTIFI_CLIENT_SECRET": os.getenv(
